...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 43.2640088;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -79.87494730000003;

  var infoWindow = new google.maps.InfoWindow();
  // fetch the data from the API
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (response) {
...
function typeAhead(search) {
  ...
  searchInput.addEventListener('input', function () {
    ...
    axios.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = '<div class="search__result"><p>No Results for ' + _this.value + ' Found</p></div>';
    }).catch(function (err) {
      console.error(err);
    });
  });
...
(0, _autocomplete2.default)((0, _bling.$)('#address-name'), (0, _bling.$)('#lat'), (0, _bling.$)('#lng'));
(0, _map2.default)((0, _bling.$)('#map'));

var heartForms = (0, _bling.$$)('form.heart');
heartForms.on('submit', _heart2.default);

var search = (0, _bling.$)('.search');
(0, _typeAhead2.default)(search);
